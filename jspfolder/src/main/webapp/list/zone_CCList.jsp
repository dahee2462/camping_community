...
<!-- 게시판페이지 이름 -->
		...
		<div class="frms">
<!-- 게시글 정렬폼 -->
		<form name="frm1" action="zone_CCList.jsp" method="get" id="frm1">
<!-- 게시글 정렬종류 -->
...
<!-- 게시글 검색폼 -->
		<form name="frm2" action="zone_CCList.jsp" method="get" id="frm2">
			...
			<tr>
				...
				<td>
					...
					<a href="<%=request.getContextPath()%>
							/board/view.jsp?bno=<%=bno%>&blist=zone_CC"><%=btitle %></a>
...
%>
	...
	<!-- 글쓰기 버튼: blist파라미터 넘기기 -->
		<button class="writeBtn" 
		 onclick="location.href='<%=request.getContextPath()%>/board/write.jsp?blist=zone_CC'">글쓰기
		</button>
	</div>
<% 
	}
...
%>
		<span class="paging">
		<a href="zone_CCList.jsp?nowPage=<%=pagingVO.getStartPage()-1%>
